...
const Tracking = () => {
  ...
  const mapEmbedUrl = `https://www.google.com/maps/embed/v1/directions?key=${import.meta.env.VITE_MAPS_API_KEY}&origin=Sua+Localização&destination=Destino+da+Viagem&mode=driving`;
